...
const AboutUsSection = () => {
  ...
  return (
    <>
      ...
      <ScrollExpandMedia
        mediaType="video"
        mediaSrc="/images/1122(5).mp4" // Replace with your video path
        posterSrc="/images/36.jpeg" // Replace with your poster image
        bgImageSrc="/images/36.jpeg" // Replace with your background image
        title="Dolce e Luce"
        date="Master Artistry"
        scrollToExpand="Scroll to Discover"
        textBlend={true}
      >
        {/* Content that appears after video expansion */}
